...
#This is CCCPCCCPFF architecture
...
# save results
np.savetxt('submission_7layercnn.csv', np.c_[range(1,len(test_images)+1),predicted_lables], delimiter=',', header = 'imageid,label', comments = '', fmt='%d')
